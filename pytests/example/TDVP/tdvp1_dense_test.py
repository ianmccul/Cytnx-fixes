...
def test_tdvp1_dense():
    ...
    # manifold.  For Nsites = 8 and time_step = 12 this estimate is 6.040e-10.
...
def test_tdvp1_dense_truncates_null_padded_product_state():
    chi1_As, chi1_Es = run_product_state_tdvp(chi=1, time_step=2)
    chi2_As, chi2_Es = run_product_state_tdvp(chi=2, time_step=2)
