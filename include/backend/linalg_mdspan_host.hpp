...
namespace cytnx::linalg_mdspan_backend {
  ...
  void run_kernel(qr_kernel, Matrix matrix, QMatrix q, RMatrix r) { lapack::qr(matrix, q, r); }
  ...
  void run_kernel(lq_kernel, Matrix matrix, LMatrix l, QMatrix q) { lapack::lq(matrix, l, q); }
